...
SoftwareSerial tableSerial(10, 11); // RX, TX


byte refreshTime = 5; // Time between DCC packets buffer refreshes in s
...
unsigned int decoderNumber;
int state;
unsigned int lastDecoder = 1;
unsigned int trackRequested;
...
void serialFlush(){
  while(tableSerial.available() > 0) {
    char t = tableSerial.read();
  }
}   
void sendrequest(){
  switch (decoderNumber){
      case 222:
             tableSerial.println ("98");

      break;
      
      case 223:
             tableSerial.println ("97");
            
      break;

      case 224:
            tableSerial.println ("99");
             
      break;
      
      case 225:
             tableSerial.println ("1");
             
      break;

      case 226:
             tableSerial.println ("2");
            
      break;

      case 227:
             tableSerial.println ("7");
             serialFlush();
      break;

      case 228:
             tableSerial.println ("9");
             
      break;

      case 229:
             tableSerial.println ("10");
             
      break;

      case 230:
             tableSerial.println ("11");
      break;

      case 231:
             tableSerial.println ("12");
      break;
     
      case 232:
             tableSerial.println ("13");
      break;

      case 233:
             tableSerial.println ("14");
      break;
      
      case 234:
             tableSerial.println ("15");
      break;

      case 235:
             tableSerial.println ("16");
      break;

      case 236:
             tableSerial.println ("17");
      break;

      case 237:
             tableSerial.println ("18");
      break;

      case 238:
             tableSerial.println ("19");
      break;

      case 239:
             tableSerial.println ("20");
      break;

      case 240:
             tableSerial.println ("21");
      break;

      case 241:
             tableSerial.println ("22");
      break;

      case 242:
             tableSerial.println ("23");
      break;

      case 243:
             tableSerial.println ("24");
      break;

      case 244:
             tableSerial.println ("25");
      break;

      case 245:
             tableSerial.println ("26");
      break;

      case 246:
             tableSerial.println ("27");
      break;

      case 247:
             tableSerial.println ("28");
      break;

      case 248:
             tableSerial.println ("29");
      break;

      case 249:
             tableSerial.println ("36");
      break;
      ...
      if (decoderType) { // Accessory Basic
        if (showAcc) {
          if (instrByte1&B10000000) { // Basic Accessory Decoder Packet Format
            ...
            state = bitRead(instrByte1,0);
            decoderNumber = ((decoderAddress-1)*4 + port + 1);
            if (decoderNumber!=lastDecoder){
              sendrequest();
              delay(500);
              lastDecoder=decoderNumber;
            }
           else{
